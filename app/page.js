...
L’AI che scrive **comunicati stampa, dichiarazioni e testi social** per politici e amministratori.
Scrivi <i>“scrivimi un testo su…”</i> e ottieni subito un testo pronto, ben formattato e coerente con il tuo tono.
</p>
<ul className="list-disc ml-6 space-y-2">
<li>Ufficio stampa con generazione per **Giornali / Instagram / Facebook / WhatsApp**</li>
<li>**Dichiarazione** obbligatoria nei testi per la stampa</li>
<li>Upload file con **drag & drop**</li>
<li>**Bozze/Archivio** con salvataggio</li>
<li>**News ticker** da testate italiane e internazionali</li>
</ul>
</div>
...
<button disabled={busy} className="btn w-full">{busy? 'Attendo…' : (mode==='signup'?'Crea account':'Accedi')}</button>
</form>
</div>
</section>
</main>
